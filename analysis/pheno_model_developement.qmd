...
tree_ldc_metrics_climate %>% 
  ...
  ggplot(aes(x = impervious_90m, y = DER.sos_doy))+
  geom_point()+
  geom_smooth(method = lm)
...
tree_ldc_metrics_climate %>% 
  filter(year < 2025,
         species_common == "Green Ash") %>% 
  ggplot(aes(x = irrigated_90m, y = DER.sos_doy))+
  geom_point()+
  geom_smooth(method = lm)

tree_ldc_metrics_climate %>% 
  ggplot(aes(x = impervious_90m, y = DER.eos_doy))+
  geom_point()+
  geom_smooth(method = lm)


tree_ldc_metrics_climate %>% 
  ggplot(aes(x = irrigated_90m, y = DER.eos_doy))+
  geom_point()+
  geom_smooth(method = lm)
...
sos_climate <- c("late_winter_prcp_days", "late_winter_temp", "late_winter_prcp", 
                 ...
                 "spring_prcp_days", "spring_temp", "spring_prcp", "impervious_90m")
...
eos_climate <- c("summer_temp", "summer_prcp", "summer_prcp_days","late_summer_prcp", 
                 ...
                 "late_fall_prcp", "late_fall_prcp_days", "late_fall_temp", "impervious_90m")

pos_climate <- c("late_spring_temp", "late_spring_prcp", "late_spring_prcp_days", "impervious_90m") 
