...
Under the +1.8°C warming scenarios, growing season length is projected to increase by 10.9 days over the baseline and peak canopy duration ($Senescence timing - Maturity timing$) extends by 10.8 days under moderate moisture conditions. Under the +1.8°C wet scenario, the 7% additional precipitation will not increase the growing season over the moderate scenario, but peak canopy duration is expected to increase by 14.1 days. The +1.8°C scenario with -7% precipitation showed minimal additional effects beyond temperature alone. The rate of change in the growing season length, form less than 1 day, from observed warming of +0.8°C to the projected +2°C, compared to the rate of change from the baseline to current warming current warming suggests that phonological responses to temperature may have diminishing relationship possibly indicating physiological or environmental constraints.
