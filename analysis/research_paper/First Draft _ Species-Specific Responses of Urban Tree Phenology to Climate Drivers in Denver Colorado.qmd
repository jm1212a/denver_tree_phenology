...
| Scientific Name | Common Name | Genus | n | Status | Leaf Type |
|-------------------|-------------------|---------|-------|----------|---------|
...
$$Y = f(X_1, X_2, ..., X_k, \text{tree features})$$

with $Y$ representing the phenological metric (day of year), $X_1...X_k$ representing climate predictors, and tree_features capturing individual tree characteristics. The function $f()$ is learned through an ensemble of regression trees, with each tree making sequential improvements to minimize prediction error.
