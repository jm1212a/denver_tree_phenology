...
Across all phenological stages, partial dependence analysis confirmed the key climate drivers identified through correlations while revealing substantial non-linearities, plateaus, and threshold effects (Figure X), while also confirming the species-specific variation observed in bivariate analysis.

![Partial dependence plots showing species-specific climate responses across phenological stages. Each panel shows predicted phenological timing (DOY) as a function of a key climate variable from XGBoost models, with other predictors held constant.](../../images/partial_depences_climnate_responces.png){fig-align="center"}
