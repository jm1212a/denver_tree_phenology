...
Urban trees are among the most effective natural mitigators of the urban heat island (UHI) effect. Studies have demonstrated that neighborhoods with mature tree canopy cover experience measurably cooler microclimates compared to areas with limited vegetation (Ziter et al., 2019; @Alonzo2021). As global temperatures continue to rise, the effects of UHIs are expected to intensify in the coming decades (Stone, 2012). Given the increasingly critical role of urban forests in climate resilience strategies, it is essential to understand the drivers of urban tree phenology—the seasonal patterns of leaf emergence, growth, and senescence—and how these patterns may shift as environmental conditions change.
...
As the planet warms, Denver is projected to confront both warming and precipitation uncertainty—conditions that will directly affect the timing of leaf-out, canopy development, and senescence for this urban forest. According to Colorado State University's Colorado Climate Center's most recent Climate Change in Colorado report, by mid-century, Denver is projected to see temperatures rise between 1.4°C and 3.1°C compared to the 1971–2000 baseline. The city has already warmed by approximately 1.1°C over the past 30 years, with the most pronounced increases occurring during summer and fall. Under moderate emissions scenarios, Denver's climate will resemble that of Pueblo, Colorado today, whereas higher emissions scenarios could make it feel more like Albuquerque, New Mexico.
...
| *Ailanthus altissima* | Tree of Heaven | *Ailanthus* | 426 | Invasive | od Deciduous |
...
Although the relationship between climate metrics and greenup timing is weaker than the other three phenological stages, across all species, greenup timing seemed to be driven most notably by late winter climate conditions. Late winter precipitation metrics show the strongest negative correlations with greenup timing. This suggests that wetter late winter conditions advance spring leaf emergence, having a greater effect than temperature during this period. Notably, the American Elm, Siberian Elm and Silver Maple exhibited slightly stronger sensitivity to late winter precipitation compared to most other species. This may suggest that these genera may be particularly responsive to early spring moisture availability.
...
Across all phenological stages, partial dependence analysis confirmed the key climate drivers identified through correlations while revealing substantial non-linearities, plateaus, and threshold effects (@fig-climate-pd), while also confirming the species-specific variation observed in bivariate analysis.
...
Partial dependence analysis revealed land cover effects that varied substantially by phenological stage and land cover type (@fig-landcover). Impervious surface showed relatively weak and inconsistent effects across phenological stages, with the overall trend suggesting slightly delayed greenup and maturity timing as impervious cover increased. This counterintuitive pattern—opposite of expected urban heat island effects—likely reflects the confounding influence of simultaneously reduced irrigated land and tree canopy cover as impervious surfaces increase. In semi-arid environments, the moisture stress from losing vegetated and irrigated surfaces may dominate over any thermal benefits of urban heat islands.
...
Our findings reveal stage-specific climate controls on urban tree phenology, with temperature dominating spring and fall transitions while precipitation plays a more nuanced, species-dependent role. The hierarchy in climate sensitivity—strongest for maturity, weakest for dormancy—aligns with previous studies showing spring phenology responds primarily to thermal forcing while autumn phenology reflects more complex interactions between photoperiod, temperature, and moisture stress (Schwartz et al., 2006; Gill et al., 2015).

Partial dependence analysis revealed non-linear responses and clear thresholds that provide critical context for climate projections. The U-shaped temperature response for greenup, with optima at both 0°C and 3-4°C, suggests dual pathways for chilling requirement fulfillment and heat accumulation (Chuine, 2000). The 23°C plateau for maturity and 32°C threshold for senescence likely reflect physiological limits to thermal acceleration and heat stress responses. These thresholds suggest that simple linear extrapolations from correlation coefficients may substantially overestimate climate sensitivity at temperature extremes.

Species-specific patterns appear linked to functional traits and ecological strategies. The consistently low climate sensitivity of cottonwoods across all stages aligns with their riparian ecology and deep rooting systems, which likely buffer them from atmospheric climate variability (Rood et al., 2003). High sensitivity of invasive species (Tree of Heaven, Siberian Elm) may reflect phenological plasticity facilitating establishment across diverse climates, though native species (Western Catalpa, Common Hackberry) also displayed pronounced responses, suggesting phenological plasticity represents a broader adaptive trait rather than a signature of invasiveness. Species showing strong precipitation responses (Silver Maple, American Linden, elms) are typically associated with mesic habitats, while cottonwoods' flat precipitation curves suggest drought tolerance or access to stable water sources.

The dual-phase control of senescence—with summer heat stress advancing senescence but autumn warmth delaying it—supports the hypothesis that fall phenology integrates both stress responses and favorable growing conditions (Gill et al., 2015). The 32°C heat-induced senescence threshold may represent a critical temperature beyond which leaf damage outweighs photosynthetic benefits. The relatively weak climate control of dormancy timing suggests that other factors—photoperiod, frost occurrence, or internal coupling with senescence—may play larger roles in determining complete leaf drop, consistent with studies showing dormancy is less plastic and more genetically constrained than earlier stages (Zani et al., 2020).
