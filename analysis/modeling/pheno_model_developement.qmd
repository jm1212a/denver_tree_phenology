...
# Test it
pd_temp <- get_partial_dependence(
  species_name = "American Elm",
  phenology_stage = "Greenup_doy",
  pred_var = "late_winter_temp",
...
# Plot
ggplot(pd_temp, aes(x = late_winter_temp, y = yhat)) +
  geom_smooth(size = 1.2, color = "steelblue") +
  labs(
    x = "Late Winter Temperature (°C)",
    y = "Predicted Greenup DOY",
    title = "American Elm - Greenup Response to Temperature"
  ) +
  theme_minimal()
...
pd_all_results %>%
  ...
  labs(
    ...
    title = "Partial Dependence: Species-Specific Climate Responses"
  ) +
  theme_minimal() +
  theme(
