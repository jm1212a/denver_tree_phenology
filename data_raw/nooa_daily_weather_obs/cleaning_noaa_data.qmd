...
climate_data %>%
  ...
  summarise(late_winter_prcp = sum(prcp, na.rm = TRUE), #months chosen 2,3
            ...
            late_winter_temp = mean(mean_temp, na.rm = TRUE)) -> late_winter_metrics
...
climate_data %>%
  ...
  summarise(spring_prcp = sum(prcp, na.rm = TRUE), #months chosen 3,4
            ...
            spring_temp = mean(mean_temp, na.rm = TRUE)) -> spring_metrics
...
climate_data %>%
  ...
  summarise(early_spring_prcp = sum(prcp, na.rm = TRUE), #months chosen 3,4
            ...
            early_spring_temp = mean(mean_temp, na.rm = TRUE)) -> early_spring_metrics
...
climate_data %>%
  ...
  summarise(late_spring_prcp = sum(prcp, na.rm = TRUE), #months chosen 5,6
            ...
            late_spring_temp = mean(mean_temp, na.rm = TRUE)) -> late_spring_metrics
...
climate_data %>%
  ...
  summarise(summer_prcp = sum(prcp, na.rm = TRUE), #months chosen 6,7,8
            ...
            summer_temp = mean(mean_temp, na.rm = TRUE)) -> summer_metrics
...
climate_data %>%
  ...
  summarise(late_summer_prcp = sum(prcp, na.rm = TRUE), #months chosen 8,9
            ...
            late_summer_temp = mean(mean_temp, na.rm = TRUE)) -> late_summer_metrics
...
climate_data %>%
  ...
  summarise(fall_prcp = sum(prcp, na.rm = TRUE), #months chosen 9,10,11
            ...
            fall_temp = mean(mean_temp, na.rm = TRUE)) -> fall_metrics
...
climate_data %>%
  ...
  summarise(early_fall_prcp = sum(prcp, na.rm = TRUE), #months chosen 9,10
            ...
            early_fall_temp = mean(mean_temp, na.rm = TRUE)) -> early_fall_metrics
...
climate_data %>%
  ...
  summarise(late_fall_prcp = sum(prcp, na.rm = TRUE), # months chosen 11,12
            ...
            late_fall_temp = mean(mean_temp, na.rm = TRUE)) -> late_fall_metrics

climate_data %>%
  group_by(year) %>%
  summarise(
    annual_prcp = sum(prcp, na.rm = TRUE),  # total precipitation
    annual_prcp_days = sum(prcp != 0, na.rm = TRUE),  # count of days with precipitation
    annual_mean_temp = mean(mean_temp, na.rm = TRUE)) -> annual_metrics
...
list(winter_metrics, late_winter_metrics, spring_metrics, early_spring_metrics,
     ...
     early_fall_metrics, late_fall_metrics) %>% 
