...
fits <- curvefit(extracts_samp$ndvi, extracts_samp$im_doy, tout = seq(1, 365, 1), methods)
...
# 2. Check input
INPUT <- check_input(
  extracts_samp$im_date_time, 
  extracts_samp$ndvi,
  nptperyear = 92,  # Use detected value
  south = FALSE
)
