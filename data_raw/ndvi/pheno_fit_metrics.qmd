...
plot_year <- function(data, year, tree_id, curve_method = FALSE, metric_type = FALSE){
  ...
  abline(v = data_year$Greenup_date, col = "lightgreen", lty = 2, lwd = 1.5)
  text(data_year$Greenup_date, par("usr")[4] * 0.95, 
     paste("Greenup\n", data_year$Greenup_date), 
     pos = 1, col = "lightgreen") 
  
  abline(v = data_year$Maturity_date, col = "darkgreen", lty = 2, lwd = 1.5)
  text(data_year$Maturity_date, par("usr")[4] * 0.95, 
     paste("Maturity\n", data_year$Maturity_date), 
     pos = 2, col = "darkgreen") 
  }
...
elmore_function(fit$`2020_1`$data$t, 
                fit$`2020_1`$model$Elmore$par[1], 
                fit$`2020_1`$model$Elmore$par[2], 
                fit$`2020_1`$model$Elmore$par[3],
                fit$`2020_1`$model$Elmore$par[4], 
                fit$`2020_1`$model$Elmore$par[5], 
                fit$`2020_1`$model$Elmore$par[6], 
                fit$`2020_1`$model$Elmore$par[7])

plot(fit$`2020_1`$data$t, fit$`2020_1`$data$y)

lines(fit$`2020_1`$data$t, 
      elmore_function(fit$`2020_1`$data$t, 
                     fit$`2020_1`$model$Elmore$par[1], 
                     fit$`2020_1`$model$Elmore$par[2], 
                     fit$`2020_1`$model$Elmore$par[3],
