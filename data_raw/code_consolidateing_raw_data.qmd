...
anti_join(tree_ldc_metrics_climate, multi_cylce, 
  ...
  filter(species_common %in%  c("American Elm", "American Linden", "Common Hackberry", "Eastern Cottonwood", "Green Ash", "Honey Locust", "Littleleaf Linden", "Northern Red Oak", "Plains Cottonwood", "Siberian Elm", "Silver Maple", "Tree of heaven", "Western Catalpa")) %>% 
